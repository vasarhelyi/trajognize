...
def main(argv=[]):
    ...
    for inputfile in inputfiles:
        ...
        if exp == "exp_all" or strid == "all": continue
    ...
    for key in filedict:
        ...
        for inputfile in filedict[key]:
            ...
            outdir = os.path.join(head, plotdir) # calling standard heatmap plot will differentiate again...
            ...
            outputfile.write("\n")
            outputfile.write("# this is %sdiff, %s of difference from average in the given group,\n" % (stat, stat))
