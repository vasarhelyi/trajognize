...
def main(argv=[]):
    ...
    spgm.create_gallery_description(
        headhead, "Real Feeding-Queuing matrices restricted to feeding times"
    )
    spgm.create_gallery_description(
        head,
        "Real Feeding-Queuing matrices  restricted to feeding times, reordered with the Eades-heuristics",
    )
    spgm.create_gallery_description(
        os.path.join(head, plotdir),
        """Plotted results for Real Feeding-Queuing matrices.
