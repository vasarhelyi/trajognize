...
def get_gnuplot_script(inputfile, outputfile, outputfileall, outputfileabsgrad,
        name, index, maxcol, exp, obj, pdstr, dvt_init, dvt_plot):
...
def main(argv=[]):
    ...
    spgm.create_gallery_description(os.path.join(head, plotdir), """Plotted results for daily barcode occurrence around objects.
